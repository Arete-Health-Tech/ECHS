...
const FormWizard = () => {
  ...
  const formatDateForInput = (dateStr: string) => {
    ...
    // Handle cases like DD/MM/YYYY or DD-MM-YYYY
                          ...
                          <div>
                            ...
                            <div className="flex flex-col gap-3">
                              ...
                              <Button
                                onClick={() => {
                                  uploadTemporaryCard(
                                    data.step1Temporary?.file
                                  );
                                }}
                              >
                                Upload Temporary Card
                              </Button>
                            </div>
                            <div className="grid grid-cols-2 gap-3 mt-3">
                              {errors.file && (
                      ...
                      <div className="grid gap-2 sm:grid-cols-2">
                        ...
                        <div>
                          ...
                          <Input
                            ...
                            onChange={(e) =>
                              updateStep2({ dob: e.target.value })
                            }
                          />
                          {errors.dob && (
                            <p className="text-destructive text-sm mt-1">
                ...
                {current === 3 && (
                  <>
                    <div className="grid gap-4">
                      ...
                      <div>
                        <h3 className="text-sm font-medium mb-2">
                          Step 3 Uploads Referral Letter
                        </h3>
                        <div className="flex flex-col gap-3">
                          <UploadTile
                      ...
                      <div className="grid gap-2 sm:grid-cols-2">
                        ...
                        <InputField
                          id="esmName"
                          label="ESM Name"
                          value={data.step3.esmName}
                        />
                        <InputField
                          id="relationshipWithESM"
                          label="Relationship with ESM"
                          value={data.step3.relationshipWithESM}
                        />
                        ...
                        <InputField
                          id="pdSec"
                          label="Polyclinic Remarks"
                          value={data.step3.pdSec}
                        />
                        <InputField
                          id="investigation"
                          label="Investigation"
                          value={data.step3.investigation}
                        />
                        <InputField
                          id="consultationFor"
                          label="Consultation For"
                          value={data.step3.consultationFor}
                        />
                        ...
                        <div className="sm:col-span-2">
                          ...
                          <Textarea
                            ...
                            value={data.step3.admission}
                            onChange={(e) =>
                              updateStep3({ admission: e.target.value })
                            }
                          />
                          ...
                          <Textarea
                            ...
                            onChange={(e) =>
                              updateStep3({ notes: e.target.value })
                            }
                          />
                          {errors.notes && (
                            <p className="text-destructive text-sm">
                        ...
                        {/* <div>
                          ...
                          <Input
                            ...
                            onChange={(e) =>
                              updateStep3({ date: e.target.value })
                            }
                          />
                          {errors.date3 && (
                            <p className="text-destructive text-sm mt-1">
